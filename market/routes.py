    ...
    if request.method == 'POST':
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f'Congratulations! You just sold {s_item_object.name} back to the stock', category='success')
            else:
                flash(f"Something went wrong on selling {s_item_object.name}", category="danger")
